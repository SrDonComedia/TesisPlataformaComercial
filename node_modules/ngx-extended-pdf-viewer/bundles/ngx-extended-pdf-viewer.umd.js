(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash.deburr'), require('rxjs'), require('@angular/forms'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-extended-pdf-viewer', ['exports', 'lodash.deburr', 'rxjs', '@angular/forms', '@angular/core', '@angular/common'], factory) :
    (factory((global['ngx-extended-pdf-viewer'] = {}),global.deburr,global.rxjs,global.ng.forms,global.ng.core,global.ng.common));
}(this, (function (exports,deburr,rxjs,forms,i0,common) { 'use strict';

    /**
     * @fileoverview added by tsickle
     * Generated from: lib/options/default-options.ts
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/options/service-worker-options.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    /** @type {?} */
    ...
    var NgxExtendedPdfViewerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgxExtendedPdfViewerComponent.ctorParameters = function () {
            return [
                { type: i0.NgZone },
        ...
        NgxExtendedPdfViewerComponent.propDecorators = {
            dummyComponents: [{ type: i0.ViewChild, args: [PdfDummyComponentsComponent,] }],
            root: [{ type: i0.ViewChild, args: ['root',] }],
            customFindbarInputArea: [{ type: i0.Input }],
            customToolbar: [{ type: i0.Input }],
            customFindbar: [{ type: i0.Input }],
            customFindbarButtons: [{ type: i0.Input }],
            customSecondaryToolbar: [{ type: i0.Input }],
            secondaryToolbarComponent: [{ type: i0.ViewChild, args: ['pdfSecondaryToolbarComponent',] }],
            srcChange: [{ type: i0.Output }],
            contextMenuAllowed: [{ type: i0.Input }],
            afterPrint: [{ type: i0.Output }],
            beforePrint: [{ type: i0.Output }],
            currentZoomFactor: [{ type: i0.Output }],
            enablePrint: [{ type: i0.Input }],
            delayFirstView: [{ type: i0.Input }],
            logLevel: [{ type: i0.Input }],
            enablePinchOnMobile: [{ type: i0.Input }],
            printResolution: [{ type: i0.Input }],
            rotation: [{ type: i0.Input }],
            rotationChange: [{ type: i0.Output }],
            src: [{ type: i0.Input }],
            base64Src: [{ type: i0.Input }],
            height: [{ type: i0.Input }],
            useBrowserLocale: [{ type: i0.Input }],
            backgroundColor: [{ type: i0.Input }],
            filenameForDownload: [{ type: i0.Input }],
            ignoreKeyboard: [{ type: i0.Input }],
            ignoreKeys: [{ type: i0.Input }],
            acceptKeys: [{ type: i0.Input }],
            imageResourcesPath: [{ type: i0.Input }],
            language: [{ type: i0.Input }],
            listenToURL: [{ type: i0.Input }],
            nameddest: [{ type: i0.Input }],
            password: [{ type: i0.Input }],
            showUnverifiedSignatures: [{ type: i0.Input }],
            startTabindex: [{ type: i0.Input }],
            showSidebarButton: [{ type: i0.Input }],
            showSidebarOnLoad: [{ type: i0.Input }],
            sidebarVisible: [{ type: i0.Input }],
            sidebarVisibleChange: [{ type: i0.Output }],
            showFindButton: [{ type: i0.Input }],
            showPagingButtons: [{ type: i0.Input }],
            showZoomButtons: [{ type: i0.Input }],
            showPresentationModeButton: [{ type: i0.Input }],
            showOpenFileButton: [{ type: i0.Input }],
            showPrintButton: [{ type: i0.Input }],
            showDownloadButton: [{ type: i0.Input }],
            showBookmarkButton: [{ type: i0.Input }],
            showSecondaryToolbarButton: [{ type: i0.Input }],
            showRotateButton: [{ type: i0.Input }],
            handTool: [{ type: i0.Input }],
            handToolChange: [{ type: i0.Output }],
            showHandToolButton: [{ type: i0.Input }],
            showScrollingButton: [{ type: i0.Input }],
            showSpreadButton: [{ type: i0.Input }],
            showPropertiesButton: [{ type: i0.Input }],
            showBorders: [{ type: i0.Input }],
            spread: [{ type: i0.Input }],
            spreadChange: [{ type: i0.Output }],
            page: [{ type: i0.Input }],
            pageChange: [{ type: i0.Output }],
            pageLabel: [{ type: i0.Input }],
            pageLabelChange: [{ type: i0.Output }],
            pagesLoaded: [{ type: i0.Output }],
            pageRendered: [{ type: i0.Output }],
            pdfDownloaded: [{ type: i0.Output }],
            pdfLoaded: [{ type: i0.Output }],
            pdfLoadingFailed: [{ type: i0.Output }],
            textLayer: [{ type: i0.Input }],
            textlayerRendered: [{ type: i0.Output }],
            textLayerRendered: [{ type: i0.Output }],
            updateFindMatchesCount: [{ type: i0.Output }],
            updateFindState: [{ type: i0.Output }],
            zoom: [{ type: i0.Input }],
            zoomChange: [{ type: i0.Output }],
            _mobileFriendlyZoom: [{ type: i0.Input }],
            mobileFriendlyZoom: [{ type: i0.Input }],
            mobileZoom: [{ type: i0.Input }],
            onContextMenu: [{ type: i0.HostListener, args: ['contextmenu',] }]
        };
    ...
    ***************************************************************************** */
    ...
    var PdfHandToolComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfHandToolComponent.ctorParameters = function () {
            return [
                { type: PDFNotificationService }
            ];
        };
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/toolbar/pdf-paging-area/page-number/page-number.component.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    ...
    var PdfFindbarComponent = /** @class */ (function () {
        ...
        PdfFindbarComponent.propDecorators = {
            showFindButton: [{ type: i0.Input }],
            mobileFriendlyZoomScale: [{ type: i0.Input }],
            findbarLeft: [{ type: i0.Input }],
            findbarTop: [{ type: i0.Input }],
            customFindbarInputArea: [{ type: i0.Input }],
            customFindbar: [{ type: i0.Input }],
            customFindbarButtons: [{ type: i0.Input }]
        };
    ...
    var PdfFindbarService = /** @class */ (function () {
        ...
        /** @nocollapse */ PdfFindbarService.ngInjectableDef = i0.defineInjectable({ factory: function PdfFindbarService_Factory() { return new PdfFindbarService(); }, token: PdfFindbarService, providedIn: "root" });
    ...
    var PdfFindMultipleSearchTextsComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfFindMultipleSearchTextsComponent.ctorParameters = function () {
            return [
    ...
    var PdfFirstPageComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfFirstPageComponent.ctorParameters = function () {
            return [
                { type: PDFNotificationService }
            ];
        };
    ...
    var PdfLastPageComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfLastPageComponent.ctorParameters = function () {
            return [
                { type: PDFNotificationService }
            ];
        };
    ...
    var PdfRotatePageComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfRotatePageComponent.ctorParameters = function () {
            return [
                { type: PDFNotificationService }
            ];
        };
        PdfRotatePageComponent.propDecorators = {
            showRotateButton: [{ type: i0.Input }],
            button1: [{ type: i0.ViewChild, args: ['button1',] }],
            button2: [{ type: i0.ViewChild, args: ['button2',] }]
        };
    ...
    var PdfSearchInputFieldComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfSearchInputFieldComponent.ctorParameters = function () {
            return [
                { type: PdfFindbarService }
            ];
        };
    ...
    var PdfSecondaryToolbarComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfSecondaryToolbarComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: PDFNotificationService },
                { type: i0.NgZone }
        ...
        PdfSecondaryToolbarComponent.propDecorators = {
            customSecondaryToolbar: [{ type: i0.Input }],
            secondaryToolbarTop: [{ type: i0.Input }],
            mobileFriendlyZoomScale: [{ type: i0.Input }],
            showPresentationModeButton: [{ type: i0.Input }],
            showOpenFileButton: [{ type: i0.Input }],
            showPrintButton: [{ type: i0.Input }],
            ...
            showPropertiesButton: [{ type: i0.Input }],
            spreadChange: [{ type: i0.Output }],
            secondaryMenuIsEmpty: [{ type: i0.Output }],
    ...
    var PdfSidebarComponent = /** @class */ (function () {
        ...
        PdfSidebarComponent.propDecorators = {
            sidebarPositionTop: [{ type: i0.Input }],
            showSidebarButton: [{ type: i0.Input }]
        };
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/toolbar/pdf-findbar/pdf-split-toolbar-button/pdf-split-toolbar-button.component.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var PdfSplitToolbarButtonComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfSplitToolbarButtonComponent.ctorParameters = function () { return []; };
    ...
    var PdfToolbarComponent = /** @class */ (function () {
        ...
        PdfToolbarComponent.propDecorators = {
            customToolbar: [{ type: i0.Input }],
            mobileFriendlyZoomScale: [{ type: i0.Input }],
            primaryMenuVisible: [{ type: i0.Input }],
            showBookmarkButton: [{ type: i0.Input }],
            showDownloadButton: [{ type: i0.Input }],
            showFindButton: [{ type: i0.Input }],
            showHandToolButton: [{ type: i0.Input }],
            ...
            showZoomButtons: [{ type: i0.Input }],
            textLayer: [{ type: i0.Input }],
            toolbarPaddingTop: [{ type: i0.Input }],
            toolbarWidth: [{ type: i0.Input }]
        };
    ...
    var PdfZoomDropdownComponent = /** @class */ (function () {
        ...
        PdfZoomDropdownComponent.propDecorators = {
            sizeSelector: [{ type: i0.ViewChild, args: ['sizeSelector',] }]
        };
    ...
    var PdfSelectToolComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PdfSelectToolComponent.ctorParameters = function () {
            return [
                { type: PDFNotificationService }
            ];
        };
        PdfSelectToolComponent.propDecorators = {
            showSelectToolButton: [{ type: i0.Input }]
        };
    ...
    var DynamicCssComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DynamicCssComponent.ctorParameters = function () {
            return [
                { type: i0.Renderer2 },
    ...
    var NgxExtendedPdfViewerModule = /** @class */ (function () {
        ...
        NgxExtendedPdfViewerModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        providers: [NgxExtendedPdfViewerService, PDFNotificationService, common.Location, { provide: common.LocationStrategy, useClass: common.PathLocationStrategy }],
                        exports: [
                            PdfZoomDropdownComponent,
                            PdfContextMenuComponent,
                            PdfPresentationModeComponent,
    ...
    exports.PdfSplitToolbarButtonComponent = PdfSplitToolbarButtonComponent;
    ...
    exports.ɵb = DynamicCssComponent;
    exports.ɵa = PdfDummyComponentsComponent;
    exports.ɵc = PdfFindbarService;
